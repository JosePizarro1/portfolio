      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-gray-300 mb-8 text-lg leading-relaxed text-center">
            Developer passionate about building responsive, accessible, and performant web applications.
            With a solid foundation in both frontend and backend technologies,
            I’m currently exploring the path that best aligns with my long-term goals—whether it's diving deeper into backend architecture or refining my frontend craft.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10 max-w-xl mx-auto">
            <div className="flex items-center gap-3 bg-gray-800 p-4 rounded-lg">
              ...
              <span className="text-gray-300">Tacna, Perú</span>
            </div>
